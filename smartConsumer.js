...
// You go to a shop to buy groceries.There are n items you have to buy.
// You are given an array of size n representing the price of these n items.

// You know that there is a discount coupon available that cost X rupees.
// This coupon gives you upto Y rupees off on all items, i.e. for all items that
//  costs more than Y their price reduces by Y and others you get for 0 rupees.

// Determine whether you should buy the discount coupon or not.
// You should buy the discount coupon if and only if the total price you
//  pay after buying the discount coupon is strictly less than the price you
//  were paying without buying the discount coupon.
