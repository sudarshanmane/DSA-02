...
// There are two teams, given an integer n and an array of 2n length, first n elements of an array represent the
// strength of the first team and the second n elements represent the strength of the second team, you have to
// take the absolute difference of the total strengths of both the array and if this difference is less than
// given integer k then print Valid otherwise print Invalid.
